import { IsString, IsDateString, IsOptional, IsArray, IsNumber, ValidateNested } from 'class-validator';
...
export class CreateBookingDto {
  ...
  @Type(() => CreateBookingExtraDto)
  extras?: CreateBookingExtraDto[];
}

export class CreateBookingExtraDto {
  @IsString()
...
export class BookingsController {
  ...
  create(@CurrentUser() user: any, @Body() dto: CreateBookingDto) {
    return this.bookingsService.create({
      ...
      bookedSlots: dto.bookedSlots ? dto.bookedSlots.map(s => new Date(s)) : undefined,
