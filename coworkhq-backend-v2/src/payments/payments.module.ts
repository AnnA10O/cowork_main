...
import { Controller, Post, Get, Body, Param, Headers, Module } from '@nestjs/common';
...
export class PaymentsController {
  ...
  @Roles(Role.MANAGER)
  @Get('manager')
  getManagerPayments(@CurrentUser() user: any) {
    return this.paymentsService.getManagerPayments(user.managerProfile.id);
  }
}
