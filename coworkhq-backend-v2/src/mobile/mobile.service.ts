...
export class MobileService {
  ...
  getDeskAvailability(id: string, date: string, startTime?: string, endTime?: string) {
  ...
  createBooking(customerId: string, dto: any) {
    return this.bookingsService.create({
      ...
      bookedSlots: dto.bookedSlots ? dto.bookedSlots.map((s: string) => new Date(s)) : undefined,
