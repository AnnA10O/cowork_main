...
class AppData {
  static final List<BookingModel> bookings = [
    ...
    BookingModel(
      id: '2',
      spaceName: 'Hive CP Studio',
      spaceLocation: 'Connaught Place, Delhi',
      spaceImageUrl:
          'https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=400&q=80',
      workspaceName: 'Hive CP',
      seatId: 'B-05',
    ...
    BookingModel(
      id: '3',
      spaceName: 'The Deck Co-Work',
      spaceLocation: 'Koramangala, Bengaluru',
      spaceImageUrl:
          'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=400&q=80',
      workspaceName: 'The Deck',
      seatId: 'C-03',
